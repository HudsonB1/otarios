...
import { subController, sumController, divController, multController, sqrtController, metersCmController, metersKmController, primeNumberController } from "./controller";
